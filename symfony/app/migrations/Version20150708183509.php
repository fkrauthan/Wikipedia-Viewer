 ...
 */
class Version20150708183509 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE favorite_search_results (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_1E19F2DCA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('DROP INDEX IDX_276ED51DA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recent_searches AS SELECT id, user_id FROM recent_searches');
        $this->addSql('DROP TABLE recent_searches');
        $this->addSql('CREATE TABLE recent_searches (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_276ED51DA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recent_searches (id, user_id) SELECT id, user_id FROM __temp__recent_searches');
        $this->addSql('DROP TABLE __temp__recent_searches');
