 ...
 */
class Version20150709011308 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE search_terms (id INTEGER NOT NULL, term VARCHAR(255) NOT NULL, count INTEGER NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE search_terms');
        $this->addSql('DROP INDEX IDX_1E19F2DCA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__favorite_search_results AS SELECT id, user_id FROM favorite_search_results');
        $this->addSql('DROP TABLE favorite_search_results');
